...
-- Créer d'abord le profil lié à l'utilisateur auth existant
INSERT INTO public.profiles (id, first_name, last_name, country, role, avatar_url, is_verified, is_active)
VALUES (
...
INSERT INTO public.artists (
  ...
  'https://images.unsplash.com/photo-1531427125744-ecfd6d936c79?w=400&h=400&fit=crop&crop=faces&q=80',
  true, true
) ON CONFLICT (id) DO UPDATE SET
...
VALUES
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'amandine.koffi@test.nkora.art', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', now(), '{"provider":"email","providers":["email"]}', '{"first_name":"Amandine","last_name":"Koffi","country":"Côte d''Ivoire","role":"collector"}', now(), now()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'awa.sangare@test.nkora.art', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', now(), '{"provider":"email","providers":["email"]}', '{"first_name":"Awa","last_name":"Sangare","country":"Mali","role":"collector"}', now(), now()),
  ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'jean-marc.ouedraogo@test.nkora.art', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', now(), '{"provider":"email","providers":["email"]}', '{"first_name":"Jean-Marc","last_name":"Ouedraogo","country":"Burkina Faso","role":"collector"}', now(), now())
ON CONFLICT (id) DO NOTHING;

-- 4. Enrichir les profils des nouveaux utilisateurs
...
VALUES
  ('d1111111-1111-4111-8111-111111111111', 'a1a1a1a1-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'Dansseuse aux calebasses', 'danseuse-aux-calebasses', E'Huile sur toile. Une célébration colorée du rythme communautaire togolais.', 'Peinture', 'Huile sur toile', '80 x 60 cm', 2023, 'Togo', 850000, 1, true, true, true, 'https://images.unsplash.com/photo-1509163353535-27b2f48d1e92?w=1600&h=1200&fit=crop&q=80', '2026-08-07'),
  ('d2222222-2222-4222-8222-222222222222', 'a1a1a1a1-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'Masque du sablier', 'masque-du-sablier', E'Sculpture en bois de wawa. Symbolise le temps qui file et la sagesse des ancêtres.', 'Sculpture', 'Bois de wawa', '35 x 20 x 15 cm', 2024, 'Togo', 620000, 1, true, true, false, 'https://images.unsplash.com/photo-1509163353535-27b2f5f1e6c?w=1200&h=1600&fit=crop&q=80', '2026-08-10'),
  ('d3333333-3333-4333-8333-333333333333', 'a1a1a1a1-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'Mémoire d''or', 'memoire-d-or', E'Art textile. Broderie dorée sur fond de pagne, hommage aux trésors numismatiques.', 'Art Textile', 'Broderie sur pagne', '70 x 90 cm', 2025, 'Sénégal', 1350000, 1, true, false, false, 'https://images.unsplash.com/photo-1509163353535-27b2f5f1e6c?w=1200&h=800&fit=crop&q=80', '2026-08-01')
ON CONFLICT (id) DO NOTHING;

-- Images additionnelles des œuvres
INSERT INTO public.artwork_images (id, artwork_id, url, position)
VALUES
  ('e1111111-1111-4111-8111-111111111111', 'd1111111-1111-4111-8111-111111111111', 'https://images.unsplash.com/photo-1509163353535-27b2f5f1e6c?w=800&h=600&fit=crop&q=80', 1)
...
VALUES
  ('c1111111-1111-4111-8111-111111111111', 'd1111111-1111-4111-8111-111111111111', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', E'Quelle puissance dans les couleurs ! Bravo.'),
  ('c2222222-2222-4222-8222-222222222222', 'd1111111-1111-4111-8111-111111111111', 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', E'Superbe dynamisme, on sent la musique.'),
  ('c3333333-3333-4333-8333-333333333333', 'd2222222-2222-4222-8222-222222222222', 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', E'Le wawa rend bien, très belle matière.')
ON CONFLICT (id) DO NOTHING;

-- 8. Abonnements (follows : followers_count auto-incrémenté)
INSERT INTO public.follows (id, follower_id, artist_id)
VALUES
  ('a1111111-1111-4111-8111-111111111111', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'a1a1a1a1-aaaa-4aaa-8aaa-aaaaaaaaaaaa'),
  ('a2222222-2222-4222-8222-222222222222', 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', 'a1a1a1a1-aaaa-4aaa-8aaa-aaaaaaaaaaaa'),
  ('a3333333-3333-4333-8333-333333333333', 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1a1a1a1-aaaa-4aaa-8aaa-aaaaaaaaaaaa')
ON CONFLICT (id) DO NOTHING;

-- 9. Newsletter
INSERT INTO public.newsletter_subscribers (id, email, is_active)
VALUES
  ('a4444444-4444-4444-8444-444444444444', 'awa.sangare@test.nkora.art', true)
